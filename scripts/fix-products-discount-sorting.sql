-- Fix get_products_page function to add discount sorting support
-- This adds 'discount' to the list of valid sort keys
    ...
    FROM (
        ...
        ORDER BY
            ...
            CASE WHEN p_sort_dir = 'desc' THEN
                ...
                END
            END DESC,
            -- Numeric sorts (including discount now!)
            CASE WHEN p_sort_dir = 'asc' THEN
                CASE
                    ...
                    WHEN p_sort_key = 'discount' THEN COALESCE(p.discount, 0)
                    ELSE NULL
                END
            END ASC,
            CASE WHEN p_sort_dir = 'desc' THEN
